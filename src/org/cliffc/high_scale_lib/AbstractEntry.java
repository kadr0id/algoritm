...
/**
 * A simple implementation of {@link java.util.Map.Entry}. Does not implement
 * {@link java.util.Map.Entry.setValue}, that is done by users of the class.
 *
 * @since 1.5
 * @author Cliff Click
...
abstract class AbstractEntry<TypeK, TypeV> implements Map.Entry<TypeK, TypeV> {
    ...
    /**
     * Compute
     * <code>"key.hashCode() ^ val.hashCode()"</code>
     */
    public int hashCode() {
