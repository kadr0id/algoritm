 ...
 *
 * <p><em>General note of caution:</em> The Set API allows the use of
...
public class NonBlockingSetInt extends AbstractSet<Integer> implements Serializable {
     ...
     * version of remove, requires a type-check and auto-unboxing. When possible
     * use the {@code int} version of {@link #remove(int)} for efficiency.
     *
     ...
     * {@link #add} - no autoboxing. Negative values throw
...
//  }
    ...
    /**
     * Standard Java {@link Iterator}. Not very efficient because it auto-boxes
     * the returned values.
     */
    ...
    private class iter implements Iterator<Integer> {
        ...
        iter() {
            intIterator = new NBSIIntIterator();
        }
    ...
    private static final class NBSI {
        ...
        /**
         * built a new NBSI with buffers large enough to hold bitwise operations
         * on the operands *
         */
        ...
        /**
         * Bitwise operations which store the result in this instance. Assumes
         * that this instance contains ample buffer space to store the largest
         * buffer from each NBSI in the recursive bitmap.
         *
         * Also assumes that this method is called during the construction
         * process of the bitset before the instance could be leaked to multiple
         * threads.
     **
         */
