...
final public class AdjustableSemaphore {
    ...
    /**
     * how many permits are allowed as governed by this semaphore. Access must
     * be synchronized on this object.
     */
     ...
     * to block after the call will wait until enough permits have been released
     * to have the number of outstanding permits fall below the new maximum. In
     ...
     * <code>Semaphore</code> that exposes the reducePermits call to the parent
